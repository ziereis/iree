...
// Scale and zero point are independent broadcast operands and need not vary
...
// An unsigned storage value with a wider signed zero point, as produced by ONNX
// and TFLite importers.
